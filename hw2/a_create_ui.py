...
class Window(QtWidgets.QWidget):
    ...
    def initUi(self) -> None:
        ...
        self.lineEditLogin.setPlaceholderText("Enter your login")  # TODO добавьте placeholderText "Введите логин" с помощью метода .setPlaceholderText()
        self.lineEditPassword = QtWidgets.QLineEdit()# TODO создайте виджет QLineEdit
        self.lineEditPassword.setPlaceholderText("Password here") # TODO добавьте placeholderText "Введите пароль"
        ...
        self.pushButtonLogin.setText("Sign in") # TODO установите текст "Войти" с помощью метода setText()
